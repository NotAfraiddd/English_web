<template>
  <div class="create-course">
    ...
    <div
      v-if="!checkName && this.$route.name != 'TestLevelReadingUpdate'"
      class="flex text-base gap-20 justify-center mt-10"
    >
      <div
        @click="cancelCreate"
    ...
    <div
      v-else-if="this.$route.name == 'TestLevelReadingUpdate'"
